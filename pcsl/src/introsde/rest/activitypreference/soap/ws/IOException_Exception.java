 ...
 * 
 */
@WebFault(name = "IOException", targetNamespace = "http://ws.soap.activitypreference.rest.introsde/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: introsde.rest.activitypreference.soap.ws.IOException
     */
