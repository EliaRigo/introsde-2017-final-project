 ...
 * 
 */
@WebServiceClient(name = "PeopleService", targetNamespace = "http://ws.soap.activitypreference.rest.introsde/", wsdlLocation = "http://localhost:6902/ws/general?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PEOPLESERVICE_QNAME = new QName("http://ws.soap.activitypreference.rest.introsde/", "PeopleService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:6902/ws/general?wsdl");
     ...
     *     returns General
     */
    @WebEndpoint(name = "GeneralImplPort")
    public General getGeneralImplPort() {
        return super.getPort(new QName("http://ws.soap.activitypreference.rest.introsde/", "GeneralImplPort"), General.class);
    }
     ...
     */
    @WebEndpoint(name = "GeneralImplPort")
    public General getGeneralImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.soap.activitypreference.rest.introsde/", "GeneralImplPort"), General.class, features);
    }
